...
class LokasiBarangPenemuan extends BaseWidget
{
    ...
    protected function getTableQuery(): Builder
    {
        ...
        return LaporanBarangPenemuan::query()->orderBy('updated_at', 'desc');
    }
    ...
    protected function getTableColumns(): array
    {
        return [
            Tables\Columns\TextColumn::make('lokasiKejadian.nama_lokasi') // gunakan dot notation
                ->label('Lokasi Kehilangan Penemuan'),
            Tables\Columns\TextColumn::make('tanggal_penemuan')
    ...
    {
        return [
            SelectFilter::make('tanggal_penemuan')
                ->label('Bulan')
                ->options($this->getMonthOptions())
                ->query(function (Builder $query, array $data): Builder {
                    if (isset($data['value'])) {
                        return $query->whereMonth('tanggal_penemuan', $data['value']);
                    }
